...
--
-- Down: ALTER TABLE "Change" ALTER COLUMN "windowStart" SET DATA TYPE TIMESTAMPTZ, ALTER COLUMN "windowEnd" SET DATA TYPE TIMESTAMPTZ, ALTER COLUMN "implementedAt" SET DATA TYPE TIMESTAMPTZ, ALTER COLUMN "closedAt" SET DATA TYPE TIMESTAMPTZ, ALTER COLUMN "createdAt" SET DATA TYPE TIMESTAMPTZ, ALTER COLUMN "updatedAt" SET DATA TYPE TIMESTAMPTZ; ALTER TABLE "ChangeIncidentLink" ALTER COLUMN "createdAt" SET DATA TYPE TIMESTAMPTZ, ALTER COLUMN "updatedAt" SET DATA TYPE TIMESTAMPTZ; ALTER TABLE "Client" ALTER COLUMN "createdAt" SET DATA TYPE TIMESTAMPTZ, ALTER COLUMN "updatedAt" SET DATA TYPE TIMESTAMPTZ; ALTER TABLE "Demand" ALTER COLUMN "decidedAt" SET DATA TYPE TIMESTAMPTZ, ALTER COLUMN "createdAt" SET DATA TYPE TIMESTAMPTZ, ALTER COLUMN "updatedAt" SET DATA TYPE TIMESTAMPTZ; ALTER TABLE "GuestInvite" ALTER COLUMN "expiresAt" SET DATA TYPE TIMESTAMPTZ, ALTER COLUMN "redeemedAt" SET DATA TYPE TIMESTAMPTZ, ALTER COLUMN "createdAt" SET DATA TYPE TIMESTAMPTZ, ALTER COLUMN "updatedAt" SET DATA TYPE TIMESTAMPTZ; ALTER TABLE "Incident" ALTER COLUMN "dueAt" SET DATA TYPE TIMESTAMPTZ, ALTER COLUMN "overdueNotifiedAt" SET DATA TYPE TIMESTAMPTZ, ALTER COLUMN "resolvedAt" SET DATA TYPE TIMESTAMPTZ, ALTER COLUMN "closedAt" SET DATA TYPE TIMESTAMPTZ, ALTER COLUMN "createdAt" SET DATA TYPE TIMESTAMPTZ, ALTER COLUMN "updatedAt" SET DATA TYPE TIMESTAMPTZ; ALTER TABLE "PostImplementationReview" ALTER COLUMN "reviewedAt" SET DATA TYPE TIMESTAMPTZ, ALTER COLUMN "createdAt" SET DATA TYPE TIMESTAMPTZ, ALTER COLUMN "updatedAt" SET DATA TYPE TIMESTAMPTZ; ALTER TABLE "Session" ALTER COLUMN "expires" SET DATA TYPE TIMESTAMPTZ, ALTER COLUMN "createdAt" SET DATA TYPE TIMESTAMPTZ, ALTER COLUMN "lastSeenAt" SET DATA TYPE TIMESTAMPTZ; ALTER TABLE "User" ALTER COLUMN "createdAt" SET DATA TYPE TIMESTAMPTZ, ALTER COLUMN "updatedAt" SET DATA TYPE TIMESTAMPTZ; ALTER TABLE "VerificationToken" ALTER COLUMN "expires" SET DATA TYPE TIMESTAMPTZ; ALTER TABLE "WorthAssessment" ALTER COLUMN "createdAt" SET DATA TYPE TIMESTAMPTZ, ALTER COLUMN "updatedAt" SET DATA TYPE TIMESTAMPTZ;
