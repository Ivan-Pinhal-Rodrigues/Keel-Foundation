...
-- CREATEDB: `prisma migrate dev` (Tasks 4-6) spins up a transient shadow
-- database to detect drift; the migrate role must be able to create it.
CREATE ROLE keel_migrate WITH LOGIN CREATEDB PASSWORD 'keel_migrate';
