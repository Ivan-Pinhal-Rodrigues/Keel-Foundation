...
export const AUDIT_ACTION_LABELS: Record<string, string> = {
  ...
  "change.risk_assessed": "Risk assessed",
  "change.rollback_plan_set": "Rollback plan set",
  "change.submitted_for_approval": "Submitted for approval",
  "change.advanced": "Stage advanced",
  "change.scheduled": "Window scheduled",
  "change.implementing": "Implementation started",
  "change.rolled_back": "Rolled back",
  "change.pir_recorded": "Post-implementation review recorded",
  "change.closed": "Closed",
  "change.incident_linked": "Incident linked",
